# scripts/validate_stage2_v11.py
"""Validate Stage 2 v1.1 checkpoint on LUDB val split.
...
def main():
    ...
    print("\n== Stage 2 v1.1 vs Stage 1 NK direct (LUDB val, supercategory F1) ==\n")
    ...
    out_file = OUT_DIR / f"validation_stage2_v11_{ts}.json"
