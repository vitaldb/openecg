# scripts/validate_stage2_v3.py
"""Validate Stage 2 v3 multi-DB checkpoint.
...
def main():
    ...
    # Frame F1 raw
    print("\n== Stage 2 v3 multi-DB validation ==\n")
    ...
    print("\n== Comparison ==")
    print("                | v1.0 frame F1     | v3 frame F1 (pp)  ")
    ...
    out_file = OUT_DIR / f"validation_stage2_v3_{ts}.json"
