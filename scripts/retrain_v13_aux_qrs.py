"""v13 Phase 1: retrain with FrameClassifierViTRegAux (auxiliary 4-class
...
Output:
  data/checkpoints/stage2_v13_aux_qrs.pt
  out/retrain_v13_aux_qrs_<ts>.json
"""
import sys
import time
...
def main():
    ...
    ckpt_path = CKPT_DIR / "stage2_v13_aux_qrs.pt"
    ...
    out_path = OUT_DIR / f"retrain_v13_aux_qrs_{ts}.json"
    import json
