"""v11 — d=256 L=4: very wide but shallow ViT.

Test if width over depth helps. Same q1c+pu0 merge training.
"""
...
KWARGS = dict(
    patch_size=5, d_model=256, n_heads=4, n_layers=4, ff=1024,
...
def main():
    ...
    print("Building train (q1c+pu0 merge)...", flush=True)
    ...
    out_path = OUT_DIR / f"train_v11_d256_L4_{ts}.json"
    def _safe(v):
